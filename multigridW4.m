function [Q_h] = multigridW4(Q_h, S, S_p, nodes, dx, CFL, gam, bcFlag, tsFlag, num_mg, dt)
...
%Perform two W3 cycles
for i=1:2
    [Q_2h] = multigridW3(Q_2h, S, S_p, nodes, dx, CFL, gam, bcFlag, tsFlag, (num_mg-1), dt);
end
